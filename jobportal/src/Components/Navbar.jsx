    ...
    <header className="max-w-screen-2xl container mx-auto xl:px-4 px-4">
        ...
        <a href="/" className="flex items-center gap-2 text-xl text-slate-950 ">
            ...
            <div className= " gap-2 m-5 hidden lg:block">
                <Link to="/login" className="py-2 px-5 rounded-sm m-5 bg-orange-600 " >Log In </Link>
                <Link to="/sign-up" className="py-2 px-5 m-5 rounded-sm bg-orange-600" >Sign Up </Link>
            </div>
            {/* for mobile view */}
